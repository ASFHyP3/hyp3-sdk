...
class HyP3:
    ...
    def update_jobs(self, jobs: Batch | Job, name: str) -> Batch | Job:
        ...
        params={"job_ids": [jobs.job_id], "name": name}
        response = self.session.patch(self._get_endpoint_url(f'/jobs'), params=params)
